...
export function SiteFooter() {
  return (
    <footer className="mt-24 border-t border-outline-variant/40 bg-surface-container-low">
      <div className="max-w-6xl mx-auto px-6 py-12 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 text-sm text-on-surface-variant max-w-sm leading-relaxed">
            {EVENT.tagline} Jedes Jahr im September am Campus Horn in Österreich. Kein Programm-Marathon — sondern Raum zum Atemholen mit Gott.
          </p>
        </div>
      ...
      <div className="border-t border-outline-variant/30">
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-on-surface-variant">
          ...
          <p>
            Design by{" "}
            <a href="https://wilckeweb.org" target="_blank" rel="noreferrer" className="font-semibold hover:text-primary">
              Wilckeweb.org
            </a>
          </p>
        </div>
